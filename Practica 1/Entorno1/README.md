...
Este directorio contiene los archivos y evidencias correspondientes a la configuración del Entorno 1 de la práctica, utilizando JupyterLab con el kernel de Almond para ejecutar código Scala.

## Tecnologías y Versiones Utilizadas
* Entorno: JupyterLab
* Kernel: Almond
* Lenguaje: Scala v2.12.21
* Java: JDK 17
